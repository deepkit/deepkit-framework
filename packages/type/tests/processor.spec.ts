...
test('assertEqualType 1', () => {
    ...
    expect(() =>
        expectEqualType(
            { kind: ReflectionKind.literal, literal: 'asd' },
            {
...
test('query', () => {
    expectType(
        { ops: [ReflectionOp.number, ReflectionOp.propertySignature, 0, ReflectionOp.objectLiteral, ReflectionOp.literal, 0, ReflectionOp.indexAccess], stack: ['a'] },
        {
...
test('extends fn', () => {
    ...
    expect(
        isExtendable({ kind: ReflectionKind.function, return: { kind: ReflectionKind.literal, literal: true }, parameters: [] }, { kind: ReflectionKind.function, function: Function, return: { kind: ReflectionKind.unknown }, parameters: [] }),
    ).toBe(true);
});
...
test('conditional', () => {
    //1 ? string : number
    expectType(
        { ops: [ReflectionOp.arg, 0, ReflectionOp.string, ReflectionOp.number, ReflectionOp.condition], stack: [1] },
        {
    ...
    //0 ? string : number
    expectType(
        { ops: [ReflectionOp.arg, 0, ReflectionOp.string, ReflectionOp.number, ReflectionOp.condition], stack: [0] },
        {
            kind: ReflectionKind.number,
        },
    );
...
test('object literal', () => {
    ...
    expectType(
        [ReflectionOp.string, ReflectionOp.number, ReflectionOp.indexSignature, ReflectionOp.objectLiteral],
        copyAndSetParent({
            kind: ReflectionKind.objectLiteral,
            id: 0,
            types: [{ kind: ReflectionKind.indexSignature, index: { kind: ReflectionKind.string }, type: { kind: ReflectionKind.number } }],
        }),
    );
...
test('method', () => {
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.method, 0], stack: ['name'] },
        {
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.parameter, 0, ReflectionOp.string, ReflectionOp.method, 1], stack: ['param', 'name'] },
        {
            kind: ReflectionKind.method,
            name: 'name',
            visibility: ReflectionVisibility.public,
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.parameter, 0, ReflectionOp.number, ReflectionOp.method, 1, ReflectionOp.protected], stack: ['param', 'name'] },
        {
            kind: ReflectionKind.method,
            name: 'name',
...
test('property', () => {
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.property, 0], stack: ['name'] },
        {
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.property, 0, ReflectionOp.optional], stack: ['name'] },
        {
            kind: ReflectionKind.property,
            name: 'name',
            optional: true,
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.property, 0, ReflectionOp.protected], stack: ['name'] },
        {
            kind: ReflectionKind.property,
            name: 'name',
            visibility: ReflectionVisibility.protected,
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.property, 0, ReflectionOp.optional, ReflectionOp.protected], stack: ['name'] },
        {
            kind: ReflectionKind.property,
            name: 'name',
            optional: true,
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.property, 0, ReflectionOp.optional, ReflectionOp.private], stack: ['name'] },
        {
            kind: ReflectionKind.property,
            name: 'name',
            optional: true,
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.property, 0, ReflectionOp.optional, ReflectionOp.abstract, ReflectionOp.private], stack: ['name'] },
        {
            kind: ReflectionKind.property,
            name: 'name',
            optional: true,
...
test('more advances types', () => {
    ...
    expectType([ReflectionOp.string, ReflectionOp.number, ReflectionOp.map], {
        ...
        classType: Map,
        types: [],
        arguments: [{ kind: ReflectionKind.string }, { kind: ReflectionKind.number }],
    });
    ...
    expectType(
        { ops: [ReflectionOp.frame, ReflectionOp.string, ReflectionOp.parameter, 0, ReflectionOp.void, ReflectionOp.function], stack: ['param'] },
        {
            kind: ReflectionKind.function,
            parameters: [{ kind: ReflectionKind.parameter, name: 'param', type: { kind: ReflectionKind.string } }],
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.parameter, 0, ReflectionOp.void, ReflectionOp.function], stack: ['param'] },
        {
            kind: ReflectionKind.function,
            parameters: [{ kind: ReflectionKind.parameter, name: 'param', type: { kind: ReflectionKind.string } }],
            return: { kind: ReflectionKind.void },
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.undefined, ReflectionOp.union, ReflectionOp.parameter, 0, ReflectionOp.void, ReflectionOp.function], stack: ['param'] },
        {
            kind: ReflectionKind.function,
            parameters: [
                {
    ...
    expectType(
        { ops: [ReflectionOp.string, ReflectionOp.array, ReflectionOp.parameter, 0, ReflectionOp.void, ReflectionOp.function], stack: ['param'] },
        {
            kind: ReflectionKind.function,
            parameters: [{ kind: ReflectionKind.parameter, name: 'param', type: { kind: ReflectionKind.array, type: { kind: ReflectionKind.string } } }],
            return: { kind: ReflectionKind.void },
        },
    );
});
...
test('inline class', () => {
    ...
    expectType(
        { ops: [ReflectionOp.inline, 0], stack: [external] },
        {
            kind: ReflectionKind.objectLiteral,
            id: 0,

...
test('method', () => {
    ...
    expectType(
        {
            ops: [ReflectionOp.string, ReflectionOp.parameter, 0, ReflectionOp.string, ReflectionOp.method, 1],
            stack: ['param', 'name'],
        },
        {
            kind: ReflectionKind.method,
...
test('property', () => {
    ...
    expectType(
        {
            ops: [ReflectionOp.string, ReflectionOp.property, 0, ReflectionOp.optional, ReflectionOp.protected],
            stack: ['name'],
        },
        {
            kind: ReflectionKind.property,
    ...
    expectType(
        {
            ops: [ReflectionOp.string, ReflectionOp.property, 0, ReflectionOp.optional, ReflectionOp.private],
            stack: ['name'],
        },
        {
            kind: ReflectionKind.property,
...
test('more advances types', () => {
    ...
    expectType([ReflectionOp.uint8ClampedArray], {
        kind: ReflectionKind.class,
    ...
    expectType([ReflectionOp.string, ReflectionOp.set], {
        kind: ReflectionKind.class,
        classType: Set,
        types: [],
        arguments: [{ kind: ReflectionKind.string }],
    });
    ...
    expectType(
        {
            ops: [ReflectionOp.string, ReflectionOp.parameter, 0, ReflectionOp.void, ReflectionOp.function],
            stack: ['param'],
        },
        {
            kind: ReflectionKind.function,
    ...
    expectType([ReflectionOp.string, ReflectionOp.array], {
...
test('inline class', () => {
    const external = pack({
        ops: [ReflectionOp.string, ReflectionOp.propertySignature, 0, ReflectionOp.objectLiteral],
        stack: ['a'],
    });
...
test('inline class circular', () => {
    const external = pack({
        ops: [ReflectionOp.inline, 0, ReflectionOp.propertySignature, 1, ReflectionOp.objectLiteral],
        stack: ['a'],
    });

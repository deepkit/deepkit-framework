...
test('serialize types', async () => {
    ...
    expect(serializedSchema[0].embeddedName).toBe('@:embedded/1');
    ...
    expect(serializedSchema[1].properties[1].classType).toBe('@:embedded/1');
    ...
    expect(schemas[0].name).toBe('@:embedded/1');

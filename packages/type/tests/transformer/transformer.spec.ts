...
const tests: [code: string | { [file: string]: string }, contains: string | string[]][] = [
    ...
    // [`class Entity { p: {[name: string]: number};}`, `t.record(t.string.name('name'), t.number)`],
    // [`class Entity { p: {[name: string]: number|undefined};}`, `t.record(t.string.name('name'), t.number.optional)`],
    ...
    // [`class Entity { p: string }`, `Entity.prototype.type`],


    // [`class Entity { p: {type: string}}`, `t.record(t.string, t.union(t.number, t.string)`],
];
...
Object.defineProperty(User.prototype, 'type', {enumerable: false, value: 34});

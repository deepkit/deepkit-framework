...
import { ParentLessType, ReflectionKind, Type, getTypeJitContainer } from '../src/reflection/type.js';
...
export function expectEqualType(
    actual: any,
    expected: any,
    options: { noTypeNames?: true; noOrigin?: true; excludes?: string[]; stack?: any[] } = {},
    path: string = '',
): void {

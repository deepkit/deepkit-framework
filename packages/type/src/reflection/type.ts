...
export type InlineRuntimeType<
    T extends ReceiveType<unknown> | undefined | ReflectionClass<any> | Type | number | string | boolean | bigint,
    R = any,
> =
    T extends ReflectionClass<infer K>
        ? K
        : T extends ReceiveType<unknown>
          ? R
          : T extends Type
            ? R
            : T extends undefined

    ...
    template: `
        ...
        <div class="requests overlay-scrollbar-small">
            <div class="no-requests" *ngIf="!requests.length">
                <div *ngIf="store.state.viewHttp.viewRequests === 'all'">No requests executed yet.</div>
                <div *ngIf="store.state.viewHttp.viewRequests === 'selected'">
                    <div *ngIf="store.state.route">No requests for this route executed yet.</div>
                </div>
            ...
            <div class="request" *ngFor="let r of requests; let i = index; trackBy: trackByIndex">
                <div class="line">
                    ...
                    <div class="status">
                        ...
                        >
                            {{ r.status === 0 ? (r.error ? 'ERROR' : 'pending') : r.status }}
                            {{ r.statusText }}
                        </div>
                    </div>

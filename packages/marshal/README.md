...
<div align="center">
<img src="https://raw.github.com/super-hornet/super-hornet/master/packages/marshal/assets/marshal-logo.png" />
</div>
...
**Note**: Marshal.ts will be transitioned to the Super Hornet framework, but is still available as `@marcj/marshal`.

Super Hornet Marshal is the **by far fastest** Javascript validation and serialization implementation to [marshal](https://en.wikipedia.org/wiki/Marshalling_(computer_science))

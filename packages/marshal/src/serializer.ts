...
export class SerializerCompilers {
     ...
     * introduce security issues. Marshaling from plain to your target format is made by calling first plainSerializer.deserialize()
     * and then yourSerializer.serialize() with the result, Marshal is fast enough to buy this convenience

...
test('getResolvedReflection simple', () => {
  expect(getResolvedReflection(SimpleModel, 'id')!.resolvedClassType).toBe(
    SimpleModel
  );
  expect(getResolvedReflection(SimpleModel, 'id')!.resolvedPropertyName).toBe(
    'id'
  );
  ...
  expect(getResolvedReflection(SimpleModel, 'plan')!.resolvedClassType).toBe(
    SimpleModel
  );
  expect(getResolvedReflection(SimpleModel, 'plan')!.resolvedPropertyName).toBe(
    'plan'
  );
  ...
  expect(
    getResolvedReflection(SimpleModel, 'children')!.resolvedClassType
  ).toBe(SimpleModel);
  expect(
    getResolvedReflection(SimpleModel, 'children')!.resolvedPropertyName
  ).toBe('children');
  expect(getResolvedReflection(SimpleModel, 'children')!.type).toBe('class');
  expect(getResolvedReflection(SimpleModel, 'children')!.typeValue).toBe(
    SubModel
  );
  ...
  expect(
    getResolvedReflection(SimpleModel, 'childrenMap')!.resolvedClassType
  ).toBe(SimpleModel);
  expect(
    getResolvedReflection(SimpleModel, 'childrenMap')!.resolvedPropertyName
  ).toBe('childrenMap');
  expect(getResolvedReflection(SimpleModel, 'childrenMap')!.type).toBe('class');
  expect(getResolvedReflection(SimpleModel, 'childrenMap')!.typeValue).toBe(
    SubModel
  );
...
test('getResolvedReflection deep', () => {
  expect(
    getResolvedReflection(SimpleModel, 'children.0.label')!.resolvedClassType
  ).toBe(SubModel);
  expect(
    getResolvedReflection(SimpleModel, 'children.0.label')!.resolvedPropertyName
  ).toBe('label');
  expect(getResolvedReflection(SimpleModel, 'children.0.label')!.type).toBe(
    'string'
  );
  expect(
    getResolvedReflection(SimpleModel, 'children.0.label')!.typeValue
  ).toBeNull();
  expect(getResolvedReflection(SimpleModel, 'children.0.label')!.array).toBe(
    false
  );
  expect(getResolvedReflection(SimpleModel, 'children.0.label')!.map).toBe(
    false
  );

  expect(
    getResolvedReflection(SimpleModel, 'childrenMap.foo.label')!
      .resolvedClassType
  ).toBe(SubModel);
  expect(
    getResolvedReflection(SimpleModel, 'childrenMap.foo.label')!
  ...
  expect(
    getResolvedReflection(SimpleModel, 'childrenMap.foo.label')!.type
  ).toBe('string');
  expect(
    getResolvedReflection(SimpleModel, 'childrenMap.foo.label')!.typeValue
  ).toBeNull();
  expect(
    getResolvedReflection(SimpleModel, 'childrenMap.foo.label')!.array
  ).toBe(false);
  expect(getResolvedReflection(SimpleModel, 'childrenMap.foo.label')!.map).toBe(
    false
  );

  expect(
    getResolvedReflection(SimpleModel, 'childrenMap.foo.unknown')
  ).toBeNull();

  expect(
    getResolvedReflection(SimpleModel, 'childrenMap.foo')!.resolvedClassType
  ).toBe(SimpleModel);
  expect(
    getResolvedReflection(SimpleModel, 'childrenMap.foo')!.resolvedPropertyName
  ).toBe('childrenMap');
  expect(getResolvedReflection(SimpleModel, 'childrenMap.foo')!.type).toBe(
    'class'
  );
  expect(getResolvedReflection(SimpleModel, 'childrenMap.foo')!.typeValue).toBe(
    SubModel
  );
  expect(getResolvedReflection(SimpleModel, 'childrenMap.foo')!.array).toBe(
    false
  );
  expect(getResolvedReflection(SimpleModel, 'childrenMap.foo')!.map).toBe(
    false
  );
});
...
test('getResolvedReflection deep decorator', () => {
  ...
  expect(
    getResolvedReflection(SimpleModel, 'childrenCollection.0.label')!
  ).toEqual({
...
test('getResolvedReflection decorator string', () => {
  ...
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection')!
      .resolvedClassType
  ).toBe(SimpleModel);
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection')!
      .resolvedPropertyName
  ).toBe('stringChildrenCollection');
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection')!.type
  ).toBe('class');
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection')!.typeValue
  ).toBe(StringCollectionWrapper);
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection')!.array
  ).toBe(false);
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection')!.map
  ).toBe(false);
});

test('getResolvedReflection deep decorator string', () => {
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection.0')!
      .resolvedClassType
  ).toBe(SimpleModel);
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection.0')!
  ...
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection.0')!.type
  ).toBe('string');
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection.0')!.typeValue
  ).toBeNull();
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection.0')!.array
  ).toBe(false);
  expect(
    getResolvedReflection(SimpleModel, 'stringChildrenCollection.0')!.map
  ).toBe(false);
});
...
test('partial 2', () => {
  ...
  expect(
    partialPlainToClass(SimpleModel, {
      'children.0.label': 2,
    })
...
test('partial document', () => {
  ...
  const document = partialPlainToClass(
    DocumentClass,
    {
      'pages.0.name': 5,
...
test('test enum labels', () => {
  ...
  expect(plainToClass(ModelWithLabels, { enum: MyEnum.first }).enum).toBe(
    MyEnum.first
  );
  expect(plainToClass(ModelWithLabels, { enum: MyEnum.second }).enum).toBe(
    MyEnum.second
  );
  ...
  expect(plainToClass(ModelWithLabels, { enum: 'first' }).enum).toBe(
    MyEnum.first
  );
  expect(plainToClass(ModelWithLabels, { enum: 'second' }).enum).toBe(
    MyEnum.second
  );
  expect(plainToClass(ModelWithLabels, { enum: 'third' }).enum).toBe(
    MyEnum.third
  );

  expect(() => {
    expect(plainToClass(ModelWithLabels, { enum: 'Hi' }).enum).toBe(
      MyEnum.first
    );
  }).toThrow(
    'Invalid ENUM given in property enum: Hi, valid: 0,1,2,first,second,third'
  );
});

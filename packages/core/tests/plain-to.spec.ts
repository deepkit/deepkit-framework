...
test('getResolvedReflection simple', () => {
    ...
    expect(
        getResolvedReflection(SimpleModel, 'plan')!.resolvedPropertyName
    ).toBe('plan');
    ...
    expect(getResolvedReflection(SimpleModel, 'childrenMap')!.type).toBe(
        'class'
    );
    expect(getResolvedReflection(SimpleModel, 'childrenMap')!.typeValue).toBe(
        SubModel
    );
    expect(getResolvedReflection(SimpleModel, 'childrenMap')!.array).toBe(
        false
    );
...
test('getResolvedReflection deep', () => {
    expect(
        getResolvedReflection(SimpleModel, 'children.0.label')!
            .resolvedClassType
    ).toBe(SubModel);
    expect(
        getResolvedReflection(SimpleModel, 'children.0.label')!
    ...
    expect(
        getResolvedReflection(SimpleModel, 'childrenMap.foo.label')!.map
    ).toBe(false);
    ...
    expect(
        getResolvedReflection(SimpleModel, 'childrenMap.foo')!
            .resolvedPropertyName
    ).toBe('childrenMap');
    ...
    expect(
        getResolvedReflection(SimpleModel, 'childrenMap.foo')!.typeValue
    ).toBe(SubModel);
...
test('test enum labels', () => {
    ...
    expect(plainToClass(Model, { enum: MyEnum.second }).enum).toBe(
        MyEnum.second
    );

...
export function createHttpKernel(controllers: (ClassType | {module: AppModule<any, any>, controller: ClassType})[], providers: ProviderWithScope[] = [], listeners: ClassType[] = [], middlewares: MiddlewareFactory[] = []) {

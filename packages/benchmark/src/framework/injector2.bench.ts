...
export async function main() {
    const bench = new BenchSuite('injector2');
    ...
    const module1 = new InjectorModule([Service, {provide: ScopedService, scope: 'http'}]);
    ...
    //     const s = context.getInjector(module1).get(Service);
    // });
    //
    // bench.add('injector.forForScope', () => {
    //     injector.forkForScope('http');
    // });
    //
...

    {
        ...
        // bench.add('new scope', () => {
        //     const s = context.createChildScope('http').getInjector(module2)
        // });
        ...
        bench.add('get(Controller) from new scope', () => {
            const scope = context.createChildScope('http');
            const s = scope.get(Controller, module2);
        });
    }

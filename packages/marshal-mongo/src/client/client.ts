...
import {ClassSchema, getClassSchema, partialPlainToClass, validatedPlainToClass} from '@super-hornet/marshal';
...
export class MongoClientConfig {
    ...
    protected parseConnectionString(url: string) {
        ...
        this.options = validatedPlainToClass(ConnectionOptions, parsed.query ? parseQueryString(parsed.query) : {});
    ...
    async getHosts(): Promise<Host[]> {
        if (this.isSrv) {
            ...
            const partialOptions = partialPlainToClass(ConnectionOptions, options);

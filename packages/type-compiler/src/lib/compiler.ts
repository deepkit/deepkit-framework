...
import {
    ...
    hasModifier,
    isNodeWithLocals,
    NodeConverter, NodeWithModifiers,
    PackExpression,
    ...
    protected decorateFunctionDeclaration(declaration: FunctionDeclaration) {
        ...
        if (!declaration.name) {
            ...
            return this.f.createExportAssignment(undefined, undefined, this.wrapWithAssignType(
                this.f.createFunctionExpression(modifier as ts.Modifier[], declaration.asteriskToken, declaration.name, declaration.typeParameters, declaration.parameters, declaration.type, declaration.body),
                encodedType
            ));
        }

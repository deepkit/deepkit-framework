...
test('class type var', () => {
    ...
    expect(res.app).toMatchInlineSnapshot(`
        ...
        const __ɵΩrxjs = {};
        __ɵΩrxjs.Observable = ['T', () => __ɵΩrxjs.Observable, 'source', () => __ɵΩrxjs.Operator, 'operator', () => __ɵΩrxjs.Observable, 'this', () => __ɵΩrxjs.Subscriber, 'subscriber', () => __ɵΩrxjs.TeardownLogic, '', 'subscribe', 'constructor', 'args', 'create', () => __ɵΩrxjs.Operator, () => __ɵΩrxjs.Observable, 'lift', () => __ΩPartial, () => __ɵΩrxjs.Observer, 'value', 'observerOrNext', () => __ɵΩrxjs.Subscription, 'next', 'forEach', () => __ɵΩrxjs.Observable, 'pipe', 'toPromise', () => __ɵΩrxjs.Subscribable, 'Observable', 'b!PP"7"-J3#P"e"!o$#-J3%PPPe$!7&2\\'Pe$!7(2)n*/+2,8"0-P"@2."/+3/sPe"!"o0#2%8P"7102PPe#!o4"o3"Pe$!25$/+J268P770,PPe#!25$/+28$\`09PPe#!7:0;PPe#!-J\`0<5e!!o="x"w>y'];
        const __ΩPartial = ['T', 'l+e#!e"!fRb!Pde"!gN#"y'];
        __ɵΩrxjs.Operator = ['T', 'R', () => __ɵΩrxjs.Subscriber, 'subscriber', 'source', () => __ɵΩrxjs.TeardownLogic, 'call', 'Operator', 'b!b"PPPe$"7#2$"2%n&1\\'Mw(y'];
        ...
        __ɵΩrxjs.Observer = ['T', 'value', '', 'next', 'err', 'error', 'complete', 'Observer', 'b!PPe#!2"$/#4$P"2%$/#4&P$/#4\\'Mw(y'];
        ...
        __ɵΩrxjs.Subscribable = ['T', () => __ΩPartial, () => __ɵΩrxjs.Observer, 'observer', () => __ɵΩrxjs.Unsubscribable, 'subscribe', 'Subscribable', 'b!PPe#!o#"o""2$n%1&Mw\\'y'];
        const __ΩExclude = ['T', 'U', 'l6!Re$!RPe#!e$"qk#%QRb!b"Pde"!p)y'];
        __ɵΩrxjs.Unsubscribable = ['unsubscribe', 'Unsubscribable', 'PP$1!Mw"y'];
        __ɵΩrxjs.SubscriptionLike = [() => __ɵΩrxjs.Unsubscribable, 'unsubscribe', 'closed', 'SubscriptionLike', 'Pn!P$1")4#9Mw$y'];

                ...
                <dui-window-toolbar>
                    <dui-button-group>
                        <div style="position: relative; top: -2px; margin-right: 5px;">
                            ...
                            <span style="margin-left: 8px; display: inline-block; color: var(--text-grey)"
                                >Framework Debugger</span
                            >
                        </div>
                    </dui-button-group>
                    ...
                    <div class="top-right">
                        ...
                        <div class="connection-info">
                            <div
                                class="connected"
                                *ngIf="client.client.transporter.connection | asyncRender as connected"
                            >
                                Connected
                            </div>
                        ...
                        <dui-dropdown #darkModeDropdown>
                            <dui-dropdown-item
                                (click)="duiApp.setDarkMode(undefined)"
                                [selected]="!duiApp.isDarkModeOverwritten()"

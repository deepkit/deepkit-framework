...
@Component({
    ...
    template: `
        <deepkit-box
            ...
            [title]="m.className"
            class="module"
            [class.no-imports]="m.imports.length === 0"
        >
            <div class="name">
                Name: {{ m.name || 'unnamed' }} #{{ m.id }} — This name can be used for environment configuration
                loader.
            </div>
            ...
            <div class="sections text-selection">
                <div class="services" *ngIf="services.length">
                    ...
                    <div class="entries">
                        ...
                        <module-detail-service
                            [service]="service"
                            *ngFor="let service of services; trackBy: trackByIndex"
                        ></module-detail-service>
                    </div>
                </div>
                <div class="controllers" *ngIf="controllers.length">
                    ...
                    <div class="entries">
                        ...
                        <module-detail-service
                            [service]="service"
                            *ngFor="let service of controllers; trackBy: trackByIndex"
                        ></module-detail-service>
                    </div>
                </div>
                <div class="listeners" *ngIf="listeners.length">
                    ...
                    <div class="entries">
                        ...
                        <module-detail-service
                            [service]="service"
                            *ngFor="let service of listeners; trackBy: trackByIndex"
                        ></module-detail-service>
                    </div>
                </div>
            </div>
            <div class="imported-services" *ngIf="importedServices.length">
                ...
                <div class="description" *ngIf="showImportedServices">
                    The following services have been exported by a module that
                    {{ m.className }} imported.
                </div>
                <div class="imported-services-grid text-selection" *ngIf="showImportedServices">
                    <div *ngFor="let service of importedServices; trackBy: trackByIndex">
                        ...
                        <span class="module-name">({{ service.fromModule }})</span>
                    </div>
                </div>
            </div>
        </deepkit-box>
...
export class ModuleDetailComponent implements OnChanges {
    ...
    ngOnChanges(): void {
        ...
        if (schema) {
            this.schemaCode = stringifyType(schema, {
                showDefaults: true,
                showFullDefinition: true,
                defaultValues: this.m.config,
            });
        }
    }
}

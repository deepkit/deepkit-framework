...
For detailed setup instructions for your specific environment, see the dedicated integration guides:

- **[Bundler Integration](./bundler-integration)** - Vite, esbuild, Webpack, Rollup, and other bundlers
- **[Node.js Integration](./nodejs-integration)** - ts-node, tsx, and native Node.js loaders

            ...
            <ng-container *ngFor="let g of graphs">
                <div class="benchmark-run" *ngIf="g.visible">
                    ...
                    <div class="link">
                        ...
                        Link to source:
                        <a href="https://github.com/deepkit/deepkit-benchmark/tree/master/src/{{pathFromId(g.id)}}">github.com/deepkit/deepkit-benchmark</a>.<br/>
                    </div>
                            ...
                            <table class="last-results">
                                <tr *ngFor="let d of g.data">
                                    ...
                                    <td class="y">
                                        ...
                                        {{d.first|number:'0.0-0'}}<span style="color: grey;">{{(d.first%1|number:'0.3')|slice:1}}</span>

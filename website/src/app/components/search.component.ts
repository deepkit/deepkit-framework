...
import { CommunityQuestion, DocPageResult, bodyToString, link, parseBody } from '@app/common/models';
import { Subject, debounceTime, distinctUntilChanged } from 'rxjs';

@Component({
    selector: 'app-search-result-page',
    standalone: true,
    imports: [NgIf, RouterLink, ContentRenderComponent],
    styles: [
        `
            .path {
                color: #a2a2a2;
                    ...
                    <div class="box-container scroll-small">
                        <div class="search-results" *ngIf="results">
                            <div
                                [routerLink]="link(r)"
                                (click)="visible = false"
                                class="app-search-result-item"
                                *ngFor="let r of results.community"
                            >
